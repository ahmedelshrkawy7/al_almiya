  ...
  return (
    <>
      <div className="md:px-40 px-4">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_2fr_1fr_1fr] gap-5 p-10">
      ...
      <div className="bg-[#3162DA] h-[100px] text-white text-center align-middle p-5 mt-5">
        <h2 className="text-xl">جميع الحقوق محفوظة - موقع كشف تسريبات</h2>
      </div>
    </>
  );
};
